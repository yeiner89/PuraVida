$(document).ready(function() {
    ...
    function Load() {
        if (begin) {
            ...
            $('#item_' + (active - 1 < 0 ? count_group - 1 : active - 1)).removeClass('active').addClass('hide');
        }

        $('#item_' + active).removeClass('hide').addClass('active');
    ...
    $('#back').on('click', function() {
        $('#item_' + active).removeClass('active').addClass('hide');
